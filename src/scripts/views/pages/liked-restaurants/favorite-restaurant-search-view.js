...
class FavoriteRestaurantSearchView {
  getTemplate() {
    return `
      <h2>
        <span class="title-content">Your Liked Restaurant</span>
      </h2>
      <div id="restaurant-search-container">
        <input id="query" class="search-box" type="search" placeholder="Search restaurant" aria-label="Search restaurant">
